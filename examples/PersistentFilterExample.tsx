  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ border: '1px solid #ccc', padding: '15px', borderRadius: '8px' }}>
        ...
        <p>
          Each view will remember its own sort preferences, search terms, and filter settings. Try
          changing filters, switching views, and returning to see the persistence in action.
        </p>
      ...
      >
        ...
        <ul>
          <li>
            <strong>Persistent Storage:</strong> Each view (sidebar, main, popup) maintains separate
            localStorage entries
          </li>
          <li>
            <strong>Automatic Restoration:</strong> Filter states are automatically restored when
            components mount
          </li>
          <li>
            <strong>Per-View Preferences:</strong> Users can have different sort orders and filters
          ...
          <li>
            ...
            <ul>
              <li>
                Sidebar: <code>iina-bookmarks-filters-sidebar</code>
              </li>
              <li>
                Main: <code>iina-bookmarks-filters-main</code>
              </li>
              <li>
                Popup: <code>iina-bookmarks-filters-popup</code>
              </li>
            </ul>
          </li>
        </ul>
