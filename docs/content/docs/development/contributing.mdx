...
RELEASE_TAG=vX.Y.Z make release-run  # Canonical release lane
make release  # Optional clean-install release gate
```
...
- Meet repository coverage thresholds (lines: 33%, statements: 32%, branches: 24%, functions: 23%)
...
<Callout type="info">For major changes, please open an issue for discussion first.</Callout>
