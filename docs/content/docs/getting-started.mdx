...
<Callout type="info">
  IINA Plugin Bookmarks is specifically designed for IINA and cannot be used with other media
  players.
</Callout>
...
Look for `iina-plugin-bookmarks.iinaplgz` in the release assets.
...
## Package Manager Installs (Community)

For Homebrew tap and Nix scaffold workflows, see [Package Manager Installs](/docs/package-manager-installs).
...
<Callout type="warning">
  Development builds may contain experimental features. For production use, download official
  releases.
</Callout>
...
- Review interface details in [User Interface](/docs/user-interface)
...
<Callout type="info">
  For additional help, [open an issue](https://github.com/wyattowalsh/iina-plugin-bookmarks/issues)
  on GitHub.
</Callout>
