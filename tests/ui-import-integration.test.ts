...
// Mock postMessage/onMessage for UI integration testing
// Note: These tests run in node environment, not jsdom, so we test
// the message protocol rather than actual DOM interactions.
